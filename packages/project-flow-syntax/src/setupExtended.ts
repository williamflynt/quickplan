...
export const setupConfigExtended = (): UserConfig => {
  ...
  extensionFilesOrContents.set(
    '/project-flow-syntax-grammar.json',
    new URL('../syntaxes/project-flow-syntax.tmLanguage.json', import.meta.url),
  )
                ...
                languages: [
                  {
                    ...
                    extensions: ['.project-flow-syntax'],
...
export const executeExtended = async (
