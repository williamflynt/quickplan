...
import { WasmCpmInput, WasmCpmOutput } from './types'
...
type CalculateMessage = { type: 'calculate'; tasks: WasmCpmInput[]; id: number }
type WorkerMessage = InitMessage | CalculateMessage

type ReadyMessage = { type: 'ready' }
type ResultMessage = { type: 'result'; data: WasmCpmOutput; id: number }
